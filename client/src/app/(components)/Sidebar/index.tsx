...
const Sidebar = () => {
  ...
  return (
    <div className={sidebarClassNames}>
        <div className="flex h-full flex flex-col justify-start">
            {/* Logo */}
            <div className="z-50 min-h-[56px] w-64 bg-white px-6 flex justify-between dark:bg-black items-center pt-3">
            <div className="text-xl font-bold text-gray-800 dark:text-white px-8">
            EDLIST
          </div>
          ...
          <div className="flex items-center gap-5 border-y-[1.5px] px-8 border-gray-200 dark:border-gray-700">
